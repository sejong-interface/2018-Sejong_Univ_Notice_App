...
public class seventh extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wv7 = (WebView)findViewById(R.id.MapView7);
        wv7.loadUrl("https://www.google.com/maps/search/%EC%9E%90%EC%96%911%EB%8F%99+ATM/@37.5541319,127.0625652,3670m/data=!3m1!1e3?hl=k");
        ...
        wv7.getSettings().setLoadWithOverviewMode(true);
        wv7.getSettings().setUseWideViewPort(true);
        wv7.getSettings().setBuiltInZoomControls(true);
        wv7.getSettings().setDisplayZoomControls(false); //줌인아웃 가능
